...
class Upload
{
     ...
     */
    public function callbacks(array $callback)
    {
    ...
    protected function validate()
    {
        ...
        if (empty($errors)) {
            ...
            foreach ($this->external_callback as $callback) {
                $this->execute_callbacks($callback[1], $callback[0]);
            }
        }
    }
    ...
    protected function execute_callbacks($callbacks, $object)
    {
        if (is_array($callbacks)) {
            ...
            call_user_func([$object, $callbacks], $this);
        }
    }
