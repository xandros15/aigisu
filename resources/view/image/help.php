        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    ...
                    <li>
                        <h4>Chose network tab and filter images</h4>
                        <img alt="image" src="<?= $this->pathFor('help.image', ['id' => 1]) ?>">
                    </li>
                    <li>
                        <h4>Go to "Reministre" and chose what event you want to upload</h4>
                        <img alt="image" src="<?= $this->pathFor('help.image', ['id' => 2]) ?>">
                    </li>
                    <li>
                        <h4>Check if load correctly</h4>
                        <img alt="image" src="<?= $this->pathFor('help.image', ['id' => 3]) ?>">
                    </li>
                    <li>
                        <h4>Them copy url address or open in new tab</h4>
                        <img alt="image" src="<?= $this->pathFor('help.image', ['id' => 4]) ?>">
                    </li>
                </ol>
